...
function checkNum(array $num_arry) : array
{
...
function checkString(array $str_arr, int $len=0) : array
{
...
function checkType(array $str_arr) : array
{
    $value = array_values($str_arr)[0];
...
function checkNull(array $arr) : array
{
